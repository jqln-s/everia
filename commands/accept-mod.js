...
export default {
    data: {
        ...
        deleteMessage: true,
        botType: 'Higher Up',
        description: 'Shortcut for accepting applicants for Mod'
    },
    async execute(message) {
        ...
        const response = 'Hello! Thank you so much for attending your interview earlier. We would love to offer you a spot on our team as Mod. Please let us know if you are still interested so we can send you a discord invite! If you are, please also send us an email address so we can properly share all staff documents with you.';
        let userMessage;
        try {
